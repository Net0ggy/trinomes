Ce programme en C++ permet de résoudre une équation du second degré de la forme : ax2+bx+c=0 ax2+bx+c=0 Il utilise le discriminant pour déterminer le nombre et la nature des solutions : 
